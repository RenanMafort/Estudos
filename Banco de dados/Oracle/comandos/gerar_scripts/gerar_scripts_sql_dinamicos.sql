...
SET HEADING OFF -- RETIDA O CABEÇALHO DAS COLUNAS (NOME DE CADA COLUNA)
SPOOL "D:\Curso - oracle\comandos\gerar_scripts\drop_tables.sql" --Com aspas duplas, ele reconhece o caminho completo
...
@"D:\Curso - oracle\comandos\gerar_scripts\drop_tables.sql" --Roda quanlquer script
