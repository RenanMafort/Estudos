package br.com.pucpr.bigdata.atp.implementacao6;
...
public class ImplementsReduce extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    protected void cleanup(Context context) throws IOException, InterruptedException {
        context.write(new Text("Mercadoria com maior quantidade de transacoes financeiras em 2016, no Brasil:"), null);
