...
public class StreanTest03 {
    ...
    public static void main(String[] args) {
        ...
        long count2 =stream.filter(lighNovel -> lighNovel.getPrice() <=4).distinct().count();// apos utilizat o stream devemos fazer a chamada novamente
