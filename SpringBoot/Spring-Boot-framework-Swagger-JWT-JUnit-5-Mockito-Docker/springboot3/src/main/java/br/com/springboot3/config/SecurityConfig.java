...
import br.com.springboot3.security.Jwt.JwtTokenFilter;
...
public class SecurityConfig {
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        JwtTokenFilter customizer = new JwtTokenFilter(tokenProvider);
        return http
                .httpBasic(httpBasic -> httpBasic.disable())
                .csrf(csrf -> csrf.disable())
                .addFilterBefore(customizer, UsernamePasswordAuthenticationFilter.class)
                .sessionManagement(
